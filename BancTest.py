...
#            plt.show()
    ...
    if int(path)!=0:
        ...
        configset.set('Resultat du test du {}'.format(t),'Prediction des images du digit 0', a[0])
        configset.set('Resultat du test du {}'.format(t),'Prediction des images du digit 1', a[1])
        configset.set('Resultat du test du {}'.format(t),'Prediction des images du digit 2', a[2])
        configset.set('Resultat du test du {}'.format(t),'Prediction des images du digit 3', a[3])
        configset.set('Resultat du test du {}'.format(t),'Prediction des images du digit 4', a[4])
        configset.set('Resultat du test du {}'.format(t),'Prediction des images du digit 5', a[5])
        configset.set('Resultat du test du {}'.format(t),'Prediction des images du digit 6', a[6])
        configset.set('Resultat du test du {}'.format(t),'Prediction des images du digit 7', a[7])
        configset.set('Resultat du test du {}'.format(t),'Prediction des images du digit 8', a[8])
        configset.set('Resultat du test du {}'.format(t),'Prediction des images du digit 9', a[9])
        ...
        l=[]
        l.append(parser.get('Statistique general des tests', 'pourcentage of prediction of 0 as(0,9)'))
        l.append(parser.get('Statistique general des tests', 'pourcentage of prediction of 1 as(0,9)'))
        l.append(parser.get('Statistique general des tests', 'pourcentage of prediction of 2 as(0,9)'))
        l.append(parser.get('Statistique general des tests', 'pourcentage of prediction of 3 as(0,9)'))
        l.append(parser.get('Statistique general des tests', 'pourcentage of prediction of 4 as(0,9)'))
        l.append(parser.get('Statistique general des tests', 'pourcentage of prediction of 5 as(0,9)'))
        l.append(parser.get('Statistique general des tests', 'pourcentage of prediction of 6 as(0,9)'))
        l.append(parser.get('Statistique general des tests', 'pourcentage of prediction of 7 as(0,9)'))
        l.append(parser.get('Statistique general des tests', 'pourcentage of prediction of 8 as(0,9)'))
        l.append(parser.get('Statistique general des tests', 'pourcentage of prediction of 9 as(0,9)'))
        m=[]
        for k in range(0,10):
            zut=[]
            l[k]=l[k].split(",")
        ...
        configg.set('Statistique general des tests', 'pourcentage of prediction of 0 as(0,9)', m[0])
        configg.set('Statistique general des tests', 'pourcentage of prediction of 1 as(0,9)', m[1])
        configg.set('Statistique general des tests', 'pourcentage of prediction of 2 as(0,9)', m[2])
        configg.set('Statistique general des tests', 'pourcentage of prediction of 3 as(0,9)', m[3])
        configg.set('Statistique general des tests', 'pourcentage of prediction of 4 as(0,9)', m[4])
        configg.set('Statistique general des tests', 'pourcentage of prediction of 5 as(0,9)', m[5])
        configg.set('Statistique general des tests', 'pourcentage of prediction of 6 as(0,9)', m[6])
        configg.set('Statistique general des tests', 'pourcentage of prediction of 7 as(0,9)', m[7])
        configg.set('Statistique general des tests', 'pourcentage of prediction of 8 as(0,9)', m[8])
        configg.set('Statistique general des tests', 'pourcentage of prediction of 9 as(0,9)', m[9])
        configg.add_section('reverse stats')
        configg.set('reverse stats', 'if 0 is predicted then original is:', dl[0])
        configg.set('reverse stats', 'if 1 is predicted then original is:', dl[1])
        configg.set('reverse stats', 'if 2 is predicted then original is:', dl[2])
        configg.set('reverse stats', 'if 3 is predicted then original is:', dl[3])
        configg.set('reverse stats', 'if 4 is predicted then original is:', dl[4])
        configg.set('reverse stats', 'if 5 is predicted then original is:', dl[5])
        configg.set('reverse stats', 'if 6 is predicted then original is:', dl[6])
        configg.set('reverse stats', 'if 7 is predicted then original is:', dl[7])
        configg.set('reverse stats', 'if 8 is predicted then original is:', dl[8])
        configg.set('reverse stats', 'if 9 is predicted then original is:', dl[9])
        ...
        configg.set('Resultat du dernier test du {}'.format(t),'Prediction des images du digit 0', a[0])
        configg.set('Resultat du dernier test du {}'.format(t),'Prediction des images du digit 1', a[1])
        configg.set('Resultat du dernier test du {}'.format(t),'Prediction des images du digit 2', a[2])
        configg.set('Resultat du dernier test du {}'.format(t),'Prediction des images du digit 3', a[3])
        configg.set('Resultat du dernier test du {}'.format(t),'Prediction des images du digit 4', a[4])
        configg.set('Resultat du dernier test du {}'.format(t),'Prediction des images du digit 5', a[5])
        configg.set('Resultat du dernier test du {}'.format(t),'Prediction des images du digit 6', a[6])
        configg.set('Resultat du dernier test du {}'.format(t),'Prediction des images du digit 7', a[7])
        configg.set('Resultat du dernier test du {}'.format(t),'Prediction des images du digit 8', a[8])
        configg.set('Resultat du dernier test du {}'.format(t),'Prediction des images du digit 9', a[9])
        ...
        configsett.set('Resultat du test du {}'.format(t),'Prediction des images du digit 0', a[0])
        configsett.set('Resultat du test du {}'.format(t),'Prediction des images du digit 1', a[1])
        configsett.set('Resultat du test du {}'.format(t),'Prediction des images du digit 2', a[2])
        configsett.set('Resultat du test du {}'.format(t),'Prediction des images du digit 3', a[3])
        configsett.set('Resultat du test du {}'.format(t),'Prediction des images du digit 4', a[4])
        configsett.set('Resultat du test du {}'.format(t),'Prediction des images du digit 5', a[5])
        configsett.set('Resultat du test du {}'.format(t),'Prediction des images du digit 6', a[6])
        configsett.set('Resultat du test du {}'.format(t),'Prediction des images du digit 7', a[7])
        configsett.set('Resultat du test du {}'.format(t),'Prediction des images du digit 8', a[8])
        configsett.set('Resultat du test du {}'.format(t),'Prediction des images du digit 9', a[9])
